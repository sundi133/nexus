...
export interface paths {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            data: {
                                /** @enum {string} */
                                kind: "mfa_coverage" | "admin_access" | "dormant_accounts" | "device_compliance" | "app_access" | "agent_tool_access";
                                title: string;
                                description: string;
                            }[];
                        };
    ...
    "/v1/reports/{kind}": {
        ...
        get: {
            parameters: {
                query?: {
                    format?: "json" | "csv";
                    /** @description dormant_accounts: no sign-in for this many days */
                    days?: number;
                };
                header?: never;
                path: {
    ...
    "/v1/roles": {
        ...
        /** Built-in roles, custom roles and the permission catalog */
        get: {
            parameters: {
                query?: never;
                header?: never;
    ...
    "/v1/roles/{id}": {
         ...
         * @description Everyone who had it loses it.
         */
        delete: {
            parameters: {
                query?: never;
    ...
    "/v1/users/{id}/role-grants": {
        ...
        /** A person's custom and scoped roles */
        get: {
            parameters: {
                query?: never;
                header?: never;
            ...
            responses: {
                ...
                200: {
                    ...
                    content: {
                        "application/json": {
                            data: components["schemas"]["RoleGrant"][];
                        };
                    };
                };
                /** @description Invalid request */
...
export interface components {
    schemas: {
        ...
        RoleGrant: {
             ...
             */
            id: string;
            /** @description A built-in role (helpdesk, security_analyst, readonly) or custom:<id> */
            role: string;
            name: string;
            /** @description Empty: the whole organization */
            scope: {
                /**
                 * Format: uuid
                 * @example 01926f4e-7b3a-7c1e-9d2f-3a4b5c6d7e8f
